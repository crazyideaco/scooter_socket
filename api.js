...
const app = express();
const PORT = 3031; // Choose a port for your API

app.use(bodyParser.json());

// TCP Server Connection
const tcpServerHost = '196.219.155.101'; // Update with your TCP server host
const tcpServerPort = 3000; // Update with your TCP server port
